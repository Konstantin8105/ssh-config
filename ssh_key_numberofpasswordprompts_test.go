...
func TestNumberOfPasswordPromptsInitFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapInit[NumberOfPasswordPrompts]
	if !ok {
...
func TestNumberOfPasswordPromptsValidFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapValid[NumberOfPasswordPrompts]
	if !ok {
...
func TestNumberOfPasswordPromptsParseFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapParse[NumberOfPasswordPrompts]
	if !ok {
