...
func TestKbdInteractiveAuthenticationInitFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapInit[KbdInteractiveAuthentication]
	if !ok {
...
func TestKbdInteractiveAuthenticationValidFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapValid[KbdInteractiveAuthentication]
	if !ok {
...
func TestKbdInteractiveAuthenticationParseFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapParse[KbdInteractiveAuthentication]
	if !ok {
