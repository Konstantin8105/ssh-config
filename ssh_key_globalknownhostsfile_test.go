...
func TestGlobalKnownHostsFileInitFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapInit[GlobalKnownHostsFile]
	if !ok {
...
func TestGlobalKnownHostsFileValidFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapValid[GlobalKnownHostsFile]
	if !ok {
...
func TestGlobalKnownHostsFileParseFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapParse[GlobalKnownHostsFile]
	if !ok {
