...
func TestUserKnownHostsFileInitFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapInit[UserKnownHostsFile]
	if !ok {
...
func TestUserKnownHostsFileValidFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapValid[UserKnownHostsFile]
	if !ok {
...
func TestUserKnownHostsFileParseFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapParse[UserKnownHostsFile]
	if !ok {
