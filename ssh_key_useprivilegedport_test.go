...
func TestUsePrivilegedPortInitFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapInit[UsePrivilegedPort]
	if !ok {
...
func TestUsePrivilegedPortValidFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapValid[UsePrivilegedPort]
	if !ok {
...
func TestUsePrivilegedPortParseFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapParse[UsePrivilegedPort]
	if !ok {
