...
func TestChallengeResponseAuthenticationInitFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapInit[ChallengeResponseAuthentication]
	if !ok {
...
func TestChallengeResponseAuthenticationValidFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapValid[ChallengeResponseAuthentication]
	if !ok {
...
func TestChallengeResponseAuthenticationParseFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapParse[ChallengeResponseAuthentication]
	if !ok {
