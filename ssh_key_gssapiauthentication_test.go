...
func TestGSSAPIAuthenticationInitFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapInit[GSSAPIAuthentication]
	if !ok {
...
func TestGSSAPIAuthenticationValidFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapValid[GSSAPIAuthentication]
	if !ok {
...
func TestGSSAPIAuthenticationParseFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapParse[GSSAPIAuthentication]
	if !ok {
