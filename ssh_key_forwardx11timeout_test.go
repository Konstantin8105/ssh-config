...
func TestForwardX11TimeoutInitFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapInit[ForwardX11Timeout]
	if !ok {
...
func TestForwardX11TimeoutValidFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapValid[ForwardX11Timeout]
	if !ok {
...
func TestForwardX11TimeoutParseFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapParse[ForwardX11Timeout]
	if !ok {
