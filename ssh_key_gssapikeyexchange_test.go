...
func TestGSSAPIKeyExchangeInitFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapInit[GSSAPIKeyExchange]
	if !ok {
...
func TestGSSAPIKeyExchangeValidFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapValid[GSSAPIKeyExchange]
	if !ok {
...
func TestGSSAPIKeyExchangeParseFunc(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Errorf("panic in test is not acceptable")
		}
	}()
	f, ok := mapParse[GSSAPIKeyExchange]
	if !ok {
